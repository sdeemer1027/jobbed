(function($) {
  $.fn.modallery = function( options ) {
    ...
    '</div>' +
    '<div class="modal-body"><img id="modallery-img" class="img-responsive center-block mylib" width="100%"/><p class="text-center" id="modallery-caption"></p></div>' +
    ...
    if (params.navigate) {
      ...
      $(params.caller).each(function(){
        var btn  = '<button class="btn btn-default navigator-btn" data-ref="' + $(this).data('to') +'" data-code='+i+'><img src="'+$(this).attr('src')+'" class="img-responsive mylib" width="100%"/></button>';
